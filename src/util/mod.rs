...
/// Human-readable name for a BACnet error class.
pub fn bacnet_error_class_name(class: u32) -> Option<&'static str> {
    Some(match class {
        0 => "device",
        1 => "object",
        2 => "property",
...
/// Human-readable name for a common BACnet error code.
pub fn bacnet_error_code_name(code: u32) -> Option<&'static str> {
    Some(match code {
        0 => "other",
        9 => "invalid-data-type",
...
pub fn describe_bacnet_error(class: u32, code: u32) -> String {
    ...
    match bacnet_error_code_name(code) {
...
pub mod debug {
    ...
    pub fn format_bacnet_error(error_class: u8, error_code: u8) -> String {
        let class_name = super::bacnet_error_class_name(error_class.into()).unwrap_or("unknown");
